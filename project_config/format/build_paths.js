...
module.exports = config => {
  config.buildPaths = {
    ...
    // Build.
    build: getPaths(pathInfo.scleanWorkspace, 'build'),
    // Build tmp.
    buildTmp: getPaths(pathInfo.scleanWorkspace, 'build_tmp'),
    // Build store.
    buildStore: getPaths(pathInfo.scleanWorkspace, 'build_store'),
  };
};
